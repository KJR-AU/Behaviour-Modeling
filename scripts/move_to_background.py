	   ...
	   if (key == 'children'):
		   ...
		   for child in value:
			  ...
			  backgroundExists = True
		          ...
		          print child
                          print feature['feature']['children'][backgroundIndex]
			  ...
			  #find the Background group in the graph
			   ...
			   if step['location']['line'] == ge.user['line']:
				  ...
				  #make newBackgroundItem node a child of the Background group
                                  ...
                                  matchingNodes = document.find(step['text'], None)
                                  document.modifyAttribute(matchingNodes,"parent",backgroundGroup)
				  ...
				  #append newBackgroundItem to Background steps
				  #update all locations
